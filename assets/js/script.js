...
const i18nDictionary = {
  "fr": {
    ...
    "nav_advice": "Conseils",
    "hero_title_home": "Une prise en charge médicale<br><span>au cœur de votre parcours.</span>",
    "hero_sub_home": "Trois centres d'hémodialyse de référence — Cherchell, Bouira et Aïn Oulmène — alliant expertise médicale, équipements de dernière génération et accompagnement humain.",
...
,
  ...
  "en": {
    ...
    "nav_advice": "Advice",
    "hero_title_home": "Comprehensive medical care<br><span>at the heart of your journey.</span>",
    "hero_sub_home": "Three reference hemodialysis centers — Cherchell, Bouira and Ain Oulmene — combining medical expertise, latest-generation technology and personalized care.",
...
,
  ...
  "ar": {
    ...
    "hero_title_home": "رعاية طبية متكاملة<br><span>في صميم مساركم العلاجي.</span>",
    "hero_sub_home": "ثلاثة مراكز مرجعية لتصفية الدم — شرشال، البويرة وعين ولمان — تجمع بين الخبرة الطبية، أحدث التجهيزات والمرافقة الإنسانية.",
